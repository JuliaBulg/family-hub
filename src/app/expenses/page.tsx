    ...
    <div className="flex flex-col min-h-full">
      <div className="flex-1 px-4 pt-4 pb-24">
        ...
        <div className="p-5 bg-emerald-500 text-white rounded-2xl shadow-md mb-5">
          <p className="text-sm opacity-80 mb-1">Total this month</p>
                ...
                {isOpen && (
                  <div className="border-t border-slate-100">
                    {catExpenses.length === 0 ? (
                      <p className="px-4 py-3 text-sm text-slate-400">No expenses in this category yet.</p>
                    ) : (
                      catExpenses.map(e => (
